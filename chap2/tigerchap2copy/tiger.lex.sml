       ...
       of NONE => yyAction30(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction32(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"a"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"a"
              then yyAction45(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction41(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction31(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction36(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"l"
              ...
              then if inp = #"m"
                  then yyQ41(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                  else yyQ72(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction33(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp = #"a"
...
fun yyQ89 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ89(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction6(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ4(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
